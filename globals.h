...
#define RECORD_LENGTH_TWS 53   // SYSTEM == 1 (NN,YYYY-MM-DD,HH:MM,TT.T,HHH.H,WW.W,DDD,SSSY,BB.BB\r\n)
#define RECORD_LENGTH_TWSRF 60 // SYSTEM == 2 (NN,YYYY-MM-DD,HH:MM,RR.RR,TT.T,HHH.H,WW.W,DDD,SSSY,BB.BB\r\n)
