# Release Notes: v6.09 (Jun 24, 2026)

## 🎯 Overview
Watchdog Boot Panic Fixes, Google Sheets Sync Timeout Guard, and Build System Partition Restoration
...
### From v5.3:
- **Direct upgrade** - Flash v6.09 firmware
- **No configuration changes** required

---

**v6.09 is production-ready!** 🚀
