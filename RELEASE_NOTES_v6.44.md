# Release Notes: v6.44 (Sep 14, 2026)

## 🎯 Overview
Fix backlog mask count and update dashboard TDY D/B breakdown
...
### From v5.3:
- **Direct upgrade** - Flash v6.44 firmware
- **No configuration changes** required

---

**v6.44 is production-ready!** 🚀
