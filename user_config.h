...
#define FIRMWARE_VERSION "6.01"

#define ENABLE_HEALTH_REPORT  0 // Master Switch: Enable automated device health reporting
...
#define KEYPAD_TYPE 0 // 0: 5-Pin GPIO (Legacy), 1: PCF8574 I2C Expander, 2: Nuvoton M51 I2C Processor
// --- 4. NETWORK BEHAVIOR ---
#define FILLGAP 1
#define FORCE_2G_ONLY 0   // v6.01 Fix: BSNL 4G support enabled. AT+CNMP=2 by default.
...
#define HEALTH_AUTH_KEY    "662172e5-42d1-4437-975c-db36c6a461e8" // Phase 2: Mandatory Device Secret
