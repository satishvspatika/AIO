# Release Notes: v5.61 (Mar 18, 2026)

## 🎯 Overview
v5.61 Release: Fixed Airtel HTTP 706 race condition via gprs_pdp_ready flag. Resolved RF Calibration PASS/FAIL discrepancy in SMS by synchronizing RTC RAM with persistent SPIFFS records.
...
### From v5.3:
- **Direct upgrade** - Flash v5.61 firmware
- **No configuration changes** required

---

**v5.61 is production-ready!** 🚀
